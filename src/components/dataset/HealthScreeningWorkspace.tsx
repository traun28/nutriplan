...
function tone(record: HealthScreeningRecord) { return record.status === "clean" ? "border-brand-200 bg-brand-50 text-brand-700" : "border-accent-300 bg-accent-100 text-accent-700"; }
