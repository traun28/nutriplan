...
function tone(record: HealthScreeningRecord) { return record.status === "clean" ? "border-brand-400/25 bg-brand-50 text-brand-400" : "border-accent-300/40 bg-accent-200/40 text-accent-300"; }
