    ...
    <Card className="mb-6">
      <CardBody>
        ...
        {open && <div className="mt-5 space-y-4">
          <input value={datasetName} onChange={(event) => setDatasetName(event.target.value)} aria-label="Dataset name" placeholder="Dataset name" className="h-10 w-full rounded-[10px] border border-line bg-white px-3 text-sm" />
