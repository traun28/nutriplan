...
const severityTone: Record<string, string> = {
  ...
  mild: "border-accent-300/40 bg-accent-200/40 text-accent-300",
  moderate: "border-orange-300 bg-orange-50 text-orange-700",
  significant: "border-danger-500/30 bg-danger-50 text-danger-700",
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <p className="text-xs font-bold uppercase tracking-[0.14em] text-brand-400">Participant report</p>
      ...
      <section>
        ...
        <div className="mt-2 table-scroll rounded-[10px] border border-line">
          <table aria-label="Nutrient details" className="w-full min-w-[720px] border-collapse text-xs">
  ...
  return (
    <Card>
      <CardBody className="space-y-6">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.14em] text-brand-400">Nutrition gap analysis</p>
